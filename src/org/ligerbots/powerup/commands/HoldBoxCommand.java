...
public class HoldBoxCommand extends Command {
  ...
  double startTime;
    ...
    protected void execute() {
      ...
      Robot.intake.intakeOn(false, /*Robot.proximitySensor.getDistanceLeft() < RobotMap.ULTRASONIC_DISTANCE_THRESHOLD ? 0.0 :*/ 0.75); //switch back to 0.9 if ultrasonics work
